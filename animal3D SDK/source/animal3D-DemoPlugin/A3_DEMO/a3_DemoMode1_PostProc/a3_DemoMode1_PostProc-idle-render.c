...
void a3postproc_render(a3_DemoState const* demoState, a3_DemoMode1_PostProc const* demoMode, a3f64 const dt)
{
	...
	const a3_Framebuffer* writeFBO[postproc_renderPass_max] = {
		...
		demoState->fbo_c16x4_d24s8,					// Scene Render
		demoState->fbo_c16_szHalf + 0,				// Bright Half
		demoState->fbo_c16_szHalf + 1,				// Blur Half - H
		demoState->fbo_c16_szHalf + 2,				// Blur Half - V
		demoState->fbo_c16_szQuarter + 0,			// Bright Quarter
		demoState->fbo_c16_szQuarter + 1,			// Blur Quarter - H
		demoState->fbo_c16_szQuarter + 2,			// Blur Quarter - V
		demoState->fbo_c16_szEighth + 0,			// Bright Eighth
		demoState->fbo_c16_szEighth + 1,			// Blur Eighth - H
		demoState->fbo_c16_szEighth + 2,			// Blur Eighth - V
		demoState->fbo_c16x4,						// Final Composite
	};
