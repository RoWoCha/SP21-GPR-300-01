...
out vec4 vPositionBiasedClip; //biased clip-space position
...
void main()
{
	vec4 positionClip = lightMVP[gl_InstanceID] * aPosition; //final clip-space position
	vPositionBiasedClip = bias * positionClip; //biased clip-space position
